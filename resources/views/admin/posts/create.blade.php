...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2><i class="bi bi-file-text"></i> Thêm bài viết</h2>
        <p class="text-muted mb-0">Tạo bài viết mới</p>
    </div>
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" 
                       value="{{ old('slug') }}" placeholder="Tự động tạo từ tiêu đề nếu để trống">
                @error('slug')
                    <div class="text-danger small">{{ $message }}</div>
                @enderror
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Để trống sẽ tự động đặt khi xuất bản</small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
