...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2><i class="bi bi-ticket-perforated"></i> Thêm mã giảm giá</h2>
        <p class="text-muted mb-0">Tạo mã giảm giá mới cho hệ thống</p>
    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                               value="{{ old('code') }}" required placeholder="VD: SALE2024">
                        @error('code')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="min_purchase_amount" step="0.01" min="0" 
                               class="form-control" value="{{ old('min_purchase_amount') }}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="usage_limit_per_user" min="1" 
                               class="form-control" value="{{ old('usage_limit_per_user') }}" 
                               placeholder="Để trống = không giới hạn">
                    </div>
                </div>
            </div>
